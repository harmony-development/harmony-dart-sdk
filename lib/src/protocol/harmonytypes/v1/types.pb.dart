...
class Error extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Error', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol.harmonytypes.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identifier')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'humanMessage')
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'moreDetails', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  factory Error({
    ...
    $core.String? humanMessage,
    $core.List<$core.int>? moreDetails,
  }) {
    final _result = create();
    if (identifier != null) {
    ...
    if (humanMessage != null) {
      _result.humanMessage = humanMessage;
    }
    if (moreDetails != null) {
      _result.moreDetails = moreDetails;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  $core.String get humanMessage => $_getSZ(1);
  @$pb.TagNumber(2)
  set humanMessage($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasHumanMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearHumanMessage() => clearField(2);

  @$pb.TagNumber(3)
  $core.List<$core.int> get moreDetails => $_getN(2);
  @$pb.TagNumber(3)
  set moreDetails($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasMoreDetails() => $_has(2);
  @$pb.TagNumber(3)
  void clearMoreDetails() => clearField(3);
}
