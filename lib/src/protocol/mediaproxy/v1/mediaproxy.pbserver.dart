...
abstract class MediaProxyServiceBase extends $pb.GeneratedService {
  $async.Future<$0.SiteMetadata> fetchLinkMetadata($pb.ServerContext ctx, $0.FetchLinkMetadataRequest request);
  $async.Future<$0.InstantViewResponse> instantView($pb.ServerContext ctx, $0.InstantViewRequest request);
  $async.Future<$0.CanInstantViewResponse> canInstantView($pb.ServerContext ctx, $0.InstantViewRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'FetchLinkMetadata': return $0.FetchLinkMetadataRequest();
      case 'InstantView': return $0.InstantViewRequest();
      case 'CanInstantView': return $0.InstantViewRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      case 'FetchLinkMetadata': return this.fetchLinkMetadata(ctx, request);
      case 'InstantView': return this.instantView(ctx, request);
      case 'CanInstantView': return this.canInstantView(ctx, request);
      default: throw $core.ArgumentError('Unknown method: $method');
    }
  }
